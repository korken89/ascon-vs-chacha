...
use crate::hal::pac::{timer0, TIMER0, TIMER1, TIMER2};
pub use fugit::{self, ExtU32};
use rtic_monotonic::Monotonic;

const ZERO_TIME: u32 = 4_290_000_000;
...
impl<T: Instance32> Monotonic for MonoTimer<T> {
    ...
    fn now(&mut self) -> Self::Instant {
        ...
        Self::Instant::from_ticks(self.0.cc[1].read().bits().wrapping_add(ZERO_TIME))
    }
    ...
    fn zero() -> Self::Instant {
        Self::Instant::from_ticks(ZERO_TIME)
    }
}
